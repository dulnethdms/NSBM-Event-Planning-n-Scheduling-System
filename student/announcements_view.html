<?php
/**
 * NSBM EventHub - Student Announcements Feed
 */
...
try {
    // Query all global announcements OR announcements linked to events the student registered for
    $stmt = $pdo->query("
    ...
    die("Database error loading student announcements: " . $e->getMessage());
}
                ...
                <?php foreach ($announcements as $ann): ?>
                    <div class="glass-card p-4">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-2">
                            <h4 class="fw-bold text-dark mb-0"><?php echo htmlspecialchars($ann['title']); ?></h4>
                            <?php if ($ann['event_id']): ?>
                        ...
                        <p class="text-secondary mb-3 fs-6" style="white-space: pre-line; line-height: 1.6;">
